...
class Config:
    ...
    netdissect_data_root = "/afs/csail.mit.edu/u/l/liuyingcheng/code/NetDissect/dataset_toy"
    ...
    merged_data_info_dir = "/afs/csail.mit.edu/u/l/liuyingcheng/code/NetDissect"
    ...
    scene_label_path = '/afs/csail.mit.edu/u/l/liuyingcheng/code/NetDissect/broden_lite/sceneCategories.txt'
